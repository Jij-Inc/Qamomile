...
_RANDOM_CASES = [(1, 0), (2, 1), (3, 2), (5, 42)]
_CASES = [
    ("plus", "plain"),
    ("minus", "plain"),
    ("plus", "controlled"),
...
_BOUNDARY_CASES = [
    (1, "plus", "plain", None, "ones"),
    (2, "minus", "plain", None, "zeros"),
    (3, "plus", "controlled", 0, "ones"),
    (5, "plus", "controlled", 1, "ones"),
    (2, "minus", "controlled", 0, "zeros"),
    (5, "minus", "controlled", 1, "zeros"),
]


@pytest.mark.parametrize(
    ("n", "direction", "mode", "enabled", "pattern"),
    _BOUNDARY_CASES,
)
