...
def test_Hamiltonian_rmul_wrt_same_qubit(pauli_combinations1, pauli_combinations2):
    """Test Hamiltonian right multiplication with other Hamiltonians whose all the terms are with respect to the same qubits.
