...
def test_su2():
    ansatz = create_efficient_su2_circuit(
        4, ["ry", "rz"], entanglement="linear", skip_final_rotation_layer=False, reps=2
    )
    ...
    ansatz = create_efficient_su2_circuit(
        3, ["rx", "rz"], entanglement="circular", skip_final_rotation_layer=True, reps=4
    )
    ...
    ansatz = create_efficient_su2_circuit(
        3, ["rx", "rz"], entanglement="full", skip_final_rotation_layer=True, reps=4
    )
...
def test_su2_error():
    with pytest.raises(
        NotImplementedError, match="Entanglement type sca not implemented"
    ):
        su2 = create_efficient_su2_circuit(
            4, ["ry", "rz"], entanglement="sca", skip_final_rotation_layer=False, reps=2
        )
