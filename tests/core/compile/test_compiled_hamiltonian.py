...
def test_CompiledHamiltonian():
    ...
    expr = X[i]
    compiled_hamiltonian = CompiledHamiltonian(substituted_hamiltonian=SubstitutedQuantumExpression(coeff={PauliOperator(PauliType.X, 0): 1.0}, constant=1.0, order=1), hamiltonian=Hamiltonian(expr), data=jtc.InstanceData({'N':n},{},[],{}),var_map = jtc.VariableMap({}, var_num=0, integer_bound={}),  deci_var_shape={})
    ...
    assert compiled_hamiltonian.deci_var_shape == {}
