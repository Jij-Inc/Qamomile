...
class QiskitQAOAAnsatzBuilder:
    ...
    def decode_from_quasi_dist(self, quasi_dist: qk.result.QuasiDistribution) -> jm.SampleSet:
...
def transpile_to_qaoa_ansatz(
    ...
    pubo_builder = jmt.core.pubo.transpile_to_pubo(compiled_instance, normalize=normalize, relax_method=relax_method)
    var_num = compiled_instance.var_map.var_num
    return QiskitQAOAAnsatzBuilder(pubo_builder, var_num, compiled_instance)
