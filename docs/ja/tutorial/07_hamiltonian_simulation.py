...
# %% [markdown]
# ---
# title: Suzuki–Trotter によるハミルトニアンシミュレーション
# tags: [hamiltonian-simulation, trotterization, algorithm, tutorial]
# ---
#
# # Suzuki–Trotter分解によるハミルトニアンシミュレーション (Rabi振動)
#
# <!-- BEGIN auto-tags -->
# **タグ:** <a class="tag-chip" href="../tags/hamiltonian-simulation.md">hamiltonian-simulation</a> <a class="tag-chip" href="../tags/trotterization.md">trotterization</a> <a class="tag-chip" href="../tags/algorithm.md">algorithm</a> <a class="tag-chip" href="../tags/tutorial.md">tutorial</a>
# <!-- END auto-tags -->
#
