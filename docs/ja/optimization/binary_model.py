...
#
# <!-- BEGIN auto-tags -->
# **タグ:** <a class="tag-chip" href="../tags/qamomile-optimization.md">qamomile-optimization</a> <a class="tag-chip" href="../tags/binary-model.md">binary-model</a>
# <!-- END auto-tags -->
#
...
# - [QAOAによるグラフ分割](qaoa_graph_partition): OMMXインスタンスからQamomileの`QAOAConverter`を用いてQAOAを適用する例 (直接`BinaryModel`を使うのは正規化の部分だけですが、実際にOMMXインスタンスを使ったend-to-endな例です。)
