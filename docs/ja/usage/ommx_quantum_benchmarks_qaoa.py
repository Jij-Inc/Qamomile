...
#
# **OMMX Quantum Benchmarks**は、この`ommx.v1.Instance`形式で配布される最適化ベンチマークインスタンス集です。最初に提供されているデータセットは**QOBLIB** (Quantum Optimization Benchmarking Library) [](https://arxiv.org/abs/2504.03832)で、近年の量子最適化研究で頻繁に取り上げられる9つの問題ファミリーを収録しています。具体的にはLABS、Market Split、Independent Set、Steiner Tree Packingなどが含まれます。
#
