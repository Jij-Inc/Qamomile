...
- [Introduction to the Quantum Phase Estimation (QPE)](qpe) — Apply the built-in `qpe` helper to a 4x4 unitary, sample the decoded phase, and compare precision as the counting register grows
