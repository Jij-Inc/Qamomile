...
- [Introduction to Quantum Phase Estimation](./qpe) — Apply the built-in `qpe` helper to a 4x4 unitary, sample the decoded phase, and compare precision as the counting register grows
