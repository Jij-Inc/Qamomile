...
# ## Binary search
#
# We want to use the above algorithm to find a tight bound on the problem solution, i.e. the ground state of the Hamiltonian. To do so, we find the correct value of the threshold parameter $\mu$ using the same Binary Search Algorithm as in Lin & Tong's paper.
#
