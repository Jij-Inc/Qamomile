...
See [Tutorial 03 — Vector Slicing](https://github.com/Jij-Inc/Qamomile/blob/v0.12.3/docs/en/tutorial/03_vector_slicing.ipynb) for the end-to-end walk-through.
...
- **Tutorials 03–08 are renumbered to 04–09** to make room for the new Vector Slicing tutorial — e.g. the former Tutorial 03 (Resource Estimation) is now [Tutorial 04](https://github.com/Jij-Inc/Qamomile/blob/v0.12.3/docs/en/tutorial/04_resource_estimation.ipynb), and the former Tutorial 08 (Compilation & Transpilation) is now [Tutorial 09](https://github.com/Jij-Inc/Qamomile/blob/v0.12.3/docs/en/tutorial/09_compilation_and_transpilation.ipynb). External links to specific tutorial file paths from before v0.12.3 need updating ([#395](https://github.com/Jij-Inc/Qamomile/pull/395)).
