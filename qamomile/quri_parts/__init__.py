"""QURI Parts engine for Qamomile.
...
Engine-specific quirks stay confined here: parametric circuits use
...
engines. Lowering decisions belong at emit time, not in the IR.
"""
