"""Engine-neutral observable and Hamiltonian representation.
...
dependency on any quantum SDK or on the circuit IR. Engine packages
...
- **One shared representation, converted at the edge.** Consumers
  ...
  this ``Hamiltonian``; each engine owns its own conversion module.
- **Operator semantics live here, not in engines.** Numerical
