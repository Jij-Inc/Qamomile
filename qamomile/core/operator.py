...
class Hamiltonian:
    ...
    def num_qubits(self) -> int:
        ...
        # If the user did not specify the number of qubits, return the number of qubits to realise all terms.
        if self._num_qubits is None:
            return num_qubits_to_realise_terms
        else:
            # If the user specified the number of qubits, return the maximum of the two.
