...
class CudaqEmitPass(StandardEmitPass[CudaqKernelArtifact]):
    ...
    def _emit_controlled_fallback(
        ...
        # Build operand-to-target maps from block inputs.  Element
        # operands inside loop bodies are resolved later after loop
        # bindings make their indices concrete.
        block_qubit_map, block_vector_slots = _build_block_qubit_map(
