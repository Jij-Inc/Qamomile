...
from qamomile.circuit.ir.types.primitives import BlockType, ValueType
...
class BlockValue(Value[BlockType]):
    ...
    input_values: list[Value] = dataclasses.field(default_factory=list)   # store dummy values for inputs
    return_values: list[Value] = dataclasses.field(default_factory=list)  # store dummy values for returns
